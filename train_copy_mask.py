...
class Graph():
    def __init__(self, is_training=True, extend_num=0):
        ...
        with self.graph.as_default():
            ...
            vocab_mask = tf.sequence_mask(tf.reduce_max(self.z, axis=1), len(des2idx) + self.max_extend_num, dtype=tf.float32)
            ...
            if is_training:  
                # Loss
                self.y_smoothed = label_smoothing(tf.one_hot(self.z, depth=len(des2idx)+self.max_extend_num))
